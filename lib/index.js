...
const insertHeaderRow = require( './changes/insertHeaderRow' );
...
function EditTable ( opts ) {
    ...
    opts.typeHeaderCell = opts.typeHeaderCell || 'table_header_cell';
    ...
    return {
        ...
        commands: {
            ...
            insertHeaderRow: bindEditor( insertHeaderRow ),
